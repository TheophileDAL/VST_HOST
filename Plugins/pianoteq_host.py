...
PREFS_PATH = os.path.join(HOME_DIR, ".config/Modartt/Pianoteq91.prefs")
...
class Pianoteq(Modartt):
    ...
    def install(cls, callback = None):
        return super().install(HOST_NAME, PIANOTEQ_EXE, PREFS_PATH, progress_callback=callback)

    async def start(self):
        super().change_audio_device_prefs(HOST_NAME, PREFS_PATH)
