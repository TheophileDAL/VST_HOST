...
MIDI_PRESETS_TABLE = "Presets/Rakarrack/Settings/Preferences/User/midi_table.rmt"
...
class Rakarrack(Plugin):
    ...
    async def start(self):
        ...
        #virtual X11 server for rakarrack (didn't work without)
    ...
    def get_midi_table_for_preset_order(self):
        bank_preset_list = []
        table_path = os.path.join(BASE_DIR, "..", MIDI_PRESETS_TABLE)
