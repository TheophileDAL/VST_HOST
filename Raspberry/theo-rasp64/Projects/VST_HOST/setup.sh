...
echo "    sudo systemctl status vst_host.service"
echo "    tail -f $ACTUAL_DIR/vst_host.log"
echo ""
echo "=== Dans ton code Python, appelle les installations ainsi : ==="
echo "    subprocess.run(['sudo', '/bin/bash', '$INSTALL_DIR/mon_plugin.sh'])"